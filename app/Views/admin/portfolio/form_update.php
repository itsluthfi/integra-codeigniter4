        ...
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form action="<?= base_url('admin/portfolio/edit/' . $portfolio->portfolio_id . '/update') ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                        ...
                        <div class="row">
                            <div class="mb-3 col-6">
                                ...
                                <input type="text" name="portfolio_name" id="portfolio_name" class="form-control 
                                    <?= isset($validation['portfolio_name']) ? 'is-invalid' : '' ?>" value="<?= old('portfolio_name', $portfolio->portfolio_name) ?>">
                            ...
                            <div class="mb-3 col-6">
                                ...
                                <select name="category_name" id="category_name" class="form-control
                                    ...
                                    <?php foreach ($category as $categories) : ?>
                                        <?php if (old('category_name', $portfolio->category_name) == $categories->category_name) : ?>
                        ...
                        <div class="row">
                            <div class="mb-3 col-6">
                                ...
                                <input type="text" name="portfolio_client" id="portfolio_client" class="form-control 
                                    <?= isset($validation['portfolio_client']) ? 'is-invalid' : '' ?>" value="<?= old('portfolio_client', $portfolio->portfolio_client) ?>">
                            ...
                            <div class="mb-3 col-6">
                                ...
                                <input type="date" name="portfolio_date" id="portfolio_date" class="form-control 
                                    <?= isset($validation['portfolio_date']) ? 'is-invalid' : '' ?>" value="<?= old('portfolio_date', $portfolio->portfolio_date) ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" cols="30" rows="10" class="form-control
                                <?= isset($validation['description']) ? 'is-invalid' : '' ?>"><?= old('description', $portfolio->description) ?></textarea>
                        ...
                        <div class="mb-3">
                            <label for="portfolio_image">Product Image</label>
                            ...
                            <img src="<?= base_url('assets-admin/img/' . $portfolio->portfolio_image) ?>" alt="" class="preview-img mt-3" width="200">
                        </div>
                        <div class="justify-content-end d-flex">
                            <button class="btn btn-primary me-2">Edit Portfolio</button>
